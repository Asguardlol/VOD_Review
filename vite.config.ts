...
// The GitHub repo is named VOD_Review, so Pages serves it from that path. This
// must match the repo name exactly or every asset 404s.
const base = process.env.VITE_BASE ?? '/VOD_Review/'
